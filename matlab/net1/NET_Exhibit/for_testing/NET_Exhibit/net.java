 ...
 * Date: Fri Apr 15 22:18:32 2022
 * Arguments: 
 * "-B""macro_default""-W""java:NET_Exhibit,net""-T""link:lib""-d""H:\\serviceInno\\matlab\\net1\\NET_Exhibit\\for_testing""class{net:H:\\serviceInno\\matlab\\net1\\NET_Exhibit.m}"
 */
...
/**
 * The <code>net</code> class provides a Java interface to MATLAB functions. 
 * The interface is compiled from the following files:
 * <pre>
 *  H:\\serviceInno\\matlab\\net1\\NET_Exhibit.m
 * </pre>
 * The {@link #dispose} method <b>must</b> be called on a <code>net</code> instance when 
 * it is no longer needed to ensure that native resources allocated by this class are 
 * properly freed.
 * @version 0.0
 */
public class net extends MWComponentInstance<net>
{
    /**
     ...
     */
    private net (final MWMCR mcr) throws MWException
    {
        super(mcr);
    ...
    /**
     * Constructs a new instance of the <code>net</code> class.
     * @throws MWException An error has occurred during the function call.
     */
    public net() throws MWException
    {
    ...
    /**
     * @deprecated Please use the constructor {@link #net(MWComponentOptions componentOptions)}.
     * The <code>com.mathworks.toolbox.javabuilder.MWComponentOptions</code> class provides an API to set the
     * path to the component.
     * @param pathToComponent Path to component directory.
     * @throws MWException An error has occurred during the function call.
     */
    public net(String pathToComponent) throws MWException
    {
        this(NET_ExhibitMCRFactory.newInstance(getPathToComponentOptions(pathToComponent)));
    }
    
    /**
     * Constructs a new instance of the <code>net</code> class. Use this constructor to 
     ...
     * @throws MWException An error has occurred during the function call.
     */
    public net(MWComponentOptions componentOptions) throws MWException
    {
