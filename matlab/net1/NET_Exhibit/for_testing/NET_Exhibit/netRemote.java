...
/**
 * The <code>netRemote</code> class provides a Java RMI-compliant interface to MATLAB 
 * functions. The interface is compiled from the following files:
 * <pre>
 *  H:\\serviceInno\\matlab\\net1\\NET_Exhibit.m
 * </pre>
 * The {@link #dispose} method <b>must</b> be called on a <code>netRemote</code> instance 
 ...
 * generate RMI server proxy objects for instances of NET_Exhibit.net.
 */
public interface netRemote extends Poolable
{
    /**
