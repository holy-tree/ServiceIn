...
/**
 * The <code>NetApplyRemote</code> class provides a Java RMI-compliant interface to 
 * MATLAB functions. The interface is compiled from the following files:
 * <pre>
 *  H:\\serviceInno\\matlab\\net1\\NET_Apply.m
 * </pre>
 * The {@link #dispose} method <b>must</b> be called on a <code>NetApplyRemote</code> 
 ...
 * generate RMI server proxy objects for instances of NET_Apply.NetApply.
 */
public interface NetApplyRemote extends Poolable
{
    /**
     * Provides the standard interface for calling the <code>NET_Apply</code> MATLAB 
     ...
     */
    public Object[] NET_Apply(int nargout, Object... rhs) throws RemoteException;
